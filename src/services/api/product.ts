...
export const getAllProducts = async (pageNumber: Number) => {
    ...
    return await {products :respons.data.data.products,page:respons.data.page,totalPages:respons.data.total_pages};
}

export const deleteProduct = async (id: string) => {
    const response = await publicAxios.delete(`/products/${id}`);
